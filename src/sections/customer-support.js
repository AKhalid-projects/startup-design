        ...
        <Grid sx={styles.row}>
          <Box sx={styles.col}>
            <Box sx={styles.content}>
              ...
              <Text as="p">
              OmniPro is a limited liability company registered in Bahrain. 
              It was founded in 2020 with a mission of bringing to existence 
              operational excellence to the contact center solutions’ industry. 
              Regardless of our clients’ needs, we embark together in a journey 
              that will takes us to operationally excellent solutions, where each 
              employee understands and ensures the flow of value to the customer 
              and keeps the flow running.
              </Text>

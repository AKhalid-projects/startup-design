...
const TESTIMONIALS_DATA = [
  {
    image: img1,
    heading: 'Alex Teo Dell',
    designation: 'CEO Of Call Centers',
    content:
      'Thank God I have been here through Teleqon’s rating from their rating and I get the same job done.. They are the best at their field.Make sure to satisfy clients.',
  },
  {
    image: img3,
    heading: 'Aleena John',
    designation: 'CEO Of Call Centers',
    content:
      ' I have queries over some corpora- te services, and they sorted it out very quickly.I would suggest Teleqon to the people for their queries solution.',
  },
  {
    image: img2,
    heading: 'Alex Sam Martin',
    designation: 'CEO Of Call Centers',
    content:
      'Today, the best call center services do more than just answer the phone on your behalf; They monitor and respond to emails  social media& more.',
  },
];
